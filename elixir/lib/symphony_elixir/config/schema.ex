defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Tracker do
    ...
    embedded_schema do
      ...
      field(:resolved_states, {:array, :string}, default: ["Done", "Closed", "Cancelled", "Canceled", "Duplicate"])
    end
    ...
    def changeset(schema, attrs) do
      ...
      |> cast(
        attrs,
        [:kind, :endpoint, :api_key, :project_slug, :assignee, :active_states, :terminal_states, :resolved_states],
        empty_values: []
      )
    end
  end
